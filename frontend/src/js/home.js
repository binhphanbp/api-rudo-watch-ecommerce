...
import { HotNews } from '../components/HotNews.js'; // Import News section
...
if (newsContainer && typeof HotNews === 'function') {
  ...
  window.renderHotNews(); // Fallback nếu bạn dùng cách cũ
}
...
const initHomePage = async () => {
  try {
    ...
    // --- SỬA LỖI slice is not a function ---
    let rawData = [];
...
// --- HÀM RENDER SWIPER (SẢN PHẨM MỚI) ---
...
// --- HÀM RENDER GRID THƯỜNG (ROLEX / APPLE) ---
